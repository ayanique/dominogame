var Game = /** @class */ (function () {
    ...
    Game.prototype.OpenToken = function () {
        ...
        document.getElementById("status").innerHTML = "My Turn!";
    };
    Game.prototype.CloseToken = function () {
        ...
        document.getElementById("status").innerHTML = "Awaiting Time...";
    };
    ...
    Game.prototype.listen = function () {
        ...
        this.socket.on('connect', function () {
            ...
            _this.socket.emit("NEW CONNECTION", window.prompt("Type your name:"));
        });
